  ...
  return (
    <div className="relative w-full">
      <div
        ...
        className="flex items-center text-sm  font-semibold justify-between bg-[#f5f5f5] border border-[#e5e5e5] rounded-xl px-3 py-3 cursor-pointer hover:border-[#ff6933] transition"
      >
